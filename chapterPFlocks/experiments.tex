...
%To achieve this, we measured the density of points and pairs in the current partition and conducted simulations to introduce additional trajectory points within the same space. 
