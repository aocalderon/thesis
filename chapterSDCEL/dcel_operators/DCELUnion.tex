...
\begin{tikzpicture}
    ...
    \draw[fill=light-gray] (0,2) -- (2,0) -- (4,2) -- (2,4);
    \draw[fill=light-gray] (4,4) -- (6,2) -- (8,4) -- (6,6);
    \draw[fill=light-gray] (2,4) -- (4,2) -- (6,4) -- (4,6);
    \draw[fill=light-gray] (2,6) -- (4,4) -- (6,6) -- (4,8);
    \draw[fill=light-gray] (3,1) -- (4,0) -- (6,2) -- (5,3);
